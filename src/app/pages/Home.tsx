      ...
      >
        <div className="max-w-5xl mx-auto w-full flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              aria-label={theme === 'dark' ? t('theme_toggle_light') : t('theme_toggle_dark')}
        ...
        {menuOpen && (
          <nav aria-label="mobile" className="md:hidden mt-3 animate-fade-in" ref={mobileMenuRef}>
      ...
      <main className="px-6 max-w-5xl mx-auto space-y-24 pb-24">
        <section id="about" className="space-y-4" aria-label={t('about_aria')}>
          <h2 className="text-2xl font-semibold flex items-center gap-3 text-slate-800 dark:text-white">
            {t('about_title')} <span className="h-px grow bg-slate-300 dark:bg-slate-700" />
          </h2>
        ...
        <section id="projects" className="space-y-6">
          <h2 className="text-2xl font-semibold flex items-center gap-3 text-slate-800 dark:text-white">
            {t('projects_title')} <span className="h-px grow bg-slate-300 dark:bg-slate-700" />
          </h2>
          <ProjectsList />
        </section>
        <ContactSection />
